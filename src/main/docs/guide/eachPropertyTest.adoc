...
[source,java]
.src/test/java/micronaut/configuration/StadiumConfigurationTests.java
----
include::{sourceDir}/src/test/java/micronaut/configuration/StadiumConfigurationTests.java[]
----
