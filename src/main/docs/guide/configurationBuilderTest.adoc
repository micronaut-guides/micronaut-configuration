...
[source,java]
.src/test/java/micronaut/configuration/TeamConfigurationSpec.java
----
include::{sourceDir}/src/test/java/micronaut/configuration/TeamConfigurationTests.java[tag=teamConfigSpecBuilder]
----
