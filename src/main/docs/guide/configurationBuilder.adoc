...
----
include::{sourceDir}/src/main/java/example/micronaut/TeamAdmin.java[]
----
...
----
include::{sourceDir}/src/main/java/example/micronaut/TeamConfiguration.java[tag=teamConfigClassBuilder]
----
