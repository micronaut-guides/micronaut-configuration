...
[source,java]
.src/main/java/micronaut/configuration/TeamAdmin.java
----
include::{sourceDir}/src/main/java/micronaut/configuration/TeamAdmin.java[]
----
...
[source,java]
.src/main/java/micronaut/configuration/TeamConfiguration.java
----
include::{sourceDir}/src/main/java/micronaut/configuration/TeamConfiguration.java[tag=teamConfigClassBuilder]
----
