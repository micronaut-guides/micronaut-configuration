...
----
include::{sourceDir}/src/main/java/example/micronaut/TeamConfiguration.java[tag=teamConfigClassNoBuilder]

include::{sourceDir}/src/main/java/example/micronaut/TeamConfiguration.java[tag=gettersandsetters]
}
----