...
----
include::{sourceDir}/src/main/java/micronaut/configuration/TeamConfiguration.java[tag=teamConfigClassNoBuilder]

include::{sourceDir}/src/main/java/micronaut/configuration/TeamConfiguration.java[tag=gettersandsetters]
}
----